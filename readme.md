🧠 ZestLingua: AI Destekli Kişiselleştirilmiş İngilizce Konuşma Asistanı
🔍 Proje Hakkında
Bu proje, İngilizce konuşma pratiği yapmak isteyen kullanıcılar için yapay zeka destekli, seviyeye göre özelleştirilmiş, senaryoya dayalı ve etkileşimli bir dil öğrenme platformudur. Kullanıcılar, yazılı olarak İngilizce konuşmalar gerçekleştirir. Her mesaj; gramer, kelime bilgisi, akıcılık ve hedeflere uygunluk açısından analiz edilir. Sistem; A1’den C2’ye kadar CEFR seviyelerine uygun özel senaryolar, analizler ve geri bildirimler sunar.
...
Kullanıcıya belirli bir rol (turist, ev sahibi, müşteri vb.) atanır ve CEFR seviyesine uygun bir konuşma senaryosu sunulur. Her senaryoda kullanıcının tamamlaması gereken konuşma görevleri (milestone) tanımlanır.
...
Projenin frontend kısmı, modern web uygulamaları geliştirmede yaygın olarak kullanılan React kütüphanesi ile geliştirilmiştir. Kullanıcı deneyimi ön planda tutularak tasarlanan arayüz, sezgisel navigasyon yapısı ve sade tasarımı ile kullanıcıların ihtiyaç duyduğu tüm özelliklere kolayca ulaşabilmesini sağlar.
...
📸 Ekran Görüntüleri
![Kayıt Ekranı](./CodeBlooms/client/src/assets/RegisterEkrani.png)
![Giriş Ekranı](./CodeBlooms/client/src/assets/LoginEkrani.png)
![Anasayfa Ekranı](./CodeBlooms/client/src/assets/Anasayfa.png)
![Konuşma Arayüzü](./CodeBlooms/client/src/assets/ChatEkrani.png)
![Grafik Ekranı](./CodeBlooms/client/src/assets/AnalizSohbet.png)
![Analiz Ekranı](./CodeBlooms/client/src/assets/AnalizEkrani1.png)
!![Analiz Ekranı2](./CodeBlooms/client/src/assets/AnalizEkrani2.png)
![Senaryolar Ekranı](./CodeBlooms/client/src/assets/SenaryolarEkrani.png)
![Mentor Analiz Ekranı](./CodeBlooms/client/src/assets/MentorAnalizi.png)
